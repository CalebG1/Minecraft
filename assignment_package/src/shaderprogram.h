...
public:
    ...
    int attrUV;
    int attrFlag; // 0 = normal, 1 = liquid, 2 = unlit redstone wire, 3 = lit redstone wire
    ...
    int unifSampler2D; // THIS IS THE POST PROCESSING SAMPLER


    int unifSampler; // THIS IS THE TEXTURE SAMPLER
    int unifTime;
...
public:
    ...
    // Draw given object with interleaved VBO
    void drawInterleaved(Drawable &d, bool drawTransparent);

    void drawUI(Drawable &d);
